   ...
   /**
    ...
    public function searchEntryData()
    {
        return [
            ...
            'match middle dupaaaaaaaaaaaa' => ['search' => 'me ex dupaaaaaaaaa', 'result' => 'some text też dupaaaaaaaaaaa'],
            'match lowercase' => ['search' => 'text', 'result' => 'some TExt'],
            'dupa' => ['search' => 'texsik', 'result' => 'inny tekscik'],
            'dupa 2' => ['search' => 'nowa dupa', 'result' => 'inna dupa'],
        ];
    }
}
